<?php require ('partials/head.php'); ?>
    ...
    <div class="flex gap-4 md:gap-8 flex-col w-full px-6 py-4 md:px-32 md:py-6" style="font-family: Arial; letter-spacing: .1rem;">
        <form method="POST" class="flex flex-col items-center">
            <textarea placeholder="emergency meeting at 8pm..." class="placeholder:text-[15px] md:placeholder:text-[18px] bg-slate-300 p-2 w-[70vw] h-full" name="body" rows="10"></textarea>
